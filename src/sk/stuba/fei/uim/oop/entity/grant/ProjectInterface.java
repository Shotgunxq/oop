...
public interface ProjectInterface {
    ...
    /**
     * @return the workload generated by the project per year (e.g., workload per unit of budget).
     */
    int getWorkloadPerYear();

    /**
     * @return the duration of the project in years.
     */
    int getDuration();
}
