...
//
//        System.out.println("P1 "+P1.getTotalBudget());
//        System.out.println("P2 "+P2.getTotalBudget());
//        System.out.println("P3 "+P3.getTotalBudget());
//        System.out.println("P4 "+P4.getTotalBudget());
//        System.out.println("P5 "+P5.getTotalBudget());
//        System.out.println("P6 "+P6.getTotalBudget());
//        System.out.println("P7 "+P7.getTotalBudget());
//
//
//    }
//}
